        ...
        md:auto-rows-[18rem] mt-12'>
            ...
            <div className='flex items-end grid-default-color grid-1'>
                <img src="assets/coding-pov.png"
                 ...
                 -top-[1rem] md:scale-[3] md:left-50 md:inset-y-10 lg:scale-
                 [2.5]' />
                 <div className='z-10'>
                    <p className='headtext'>Hi, I'm Tài</p>
                    <p className='subtext'>
            ...
            <div className='grid-special-color grid-4'>
                ...
                justify-center gap-4  size-full'>
                    <p className='text-cent headtext'>Do you want to start a project together</p>
                <CopyEmailButton/>
                </div>
            </div>
            ...
            <div className='grid-default-color grid-5'>
                <div className='z-10 w-[50%]'>
                    ...
                    <p className='subtext'>
                        I specialize in a variety of languages, framworks, and tools taht
