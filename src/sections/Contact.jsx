...
const contact = () => {
    ...
    const handleSubmit = async (e) =>{
        ...
        try {
            ...
            await emailjs.send("service_v40asug","template_gi1w49t", {
            from_name: formData.name,
            to_name:"Tài",
            from_email: formData.email,
            to_email:"buitantai2704@gmail.com",
        ...
        bg-primary">
            ...
            mb-10">
                ...
                <p className="font-normal text-neutral-400">
                    ...
                    your existing
                    platform, or bring a unique project to lif, I'm here
                    to help
                </p>
            </div>
            <form className="w-full" onSubmit={handleSubmit}>
                ...
                <button type="submit" className="w-full px-1 py-3 text-lg 
                text-center rounded-md cursor-pointer bg-radial from-lavender
